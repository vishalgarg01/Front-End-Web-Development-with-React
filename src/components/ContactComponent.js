...
class Contact extends Component {
    ...
    validate(firstname,lastname,telnum,email){
        ...
        if(this.state.touched.firstname && firstname.length<3){
            errors.firstname='First name shoud be >= 3';
        }
        else if(firstname.length>10){
            errors.firstname='First name shoud be < 10';
        }
        if(this.state.touched.lastname && lastname.length<3){
            errors.lastname='last name shoud be >= 3';
        }
        else if(lastname.length>10){
            errors.lastname='last name shoud be < 10';
        }
            ...
            <div className="row row-content">
                ...
                <div className="col-12 col-sm-11 offset-sm-1">
                    <div className="btn-group" role="group">
                        <a role="button" className="btn btn-primary" href="tel:8950970558"><i className="fa fa-phone"></i> Call</a>
